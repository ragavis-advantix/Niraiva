            ...
            try {
                ...
                if (data.ai_status === 'failed') {
                    toast({
                        ...
                        description: `Report uploaded, but AI analysis is temporarily unavailable.`,
                        variant: 'default', // Using default as it's a success but with a caveat
                    });
                } else {
                    toast({
    ...
    const pollReportStatus = async (reportId: string) => {
        ...
        const poll = setInterval(async () => {
            ...
            if (response.ok) {
                ...
                if (['parsed', 'failed'].includes(data.status) || attempts >= 60) {
                    clearInterval(poll);
                }
            }
        }, 5000);
                                    ...
                                    >
                                        ...
                                        {report.progress !== undefined &&
                                            report.status === 'processing' && (
                                                <Progress value={report.progress} className="mt-2" />
                                            )}
                                            ...
                                            <div className="mt-3 p-3 bg-green-50 dark:bg-green-900/20 rounded-lg">
                                                ...
                                                <div className="grid grid-cols-2 gap-2 text-xs">
                                                    ...
                                                    <div>
                                                        ...
                                                        <span className="ml-1 font-medium">
                                                            {(report.parsedData.confidence * 100).toFixed(0)}%
                                                        </span>
                                                    </div>
                                                </div>
                                                ...
                                                >
                                                    <Card className="p-4 bg-blue-50 dark:bg-blue-900/20 border-blue-200 dark:border-blue-800">
                                                        ...
                                                        <p className="text-sm text-blue-800 dark:text-blue-200">
                                                            Upload your medical reports (lab results, prescriptions, etc.)
                                                        </p>
                                                    </Card>
                                                    ...
                                                    <Card className="p-4 bg-purple-50 dark:bg-purple-900/20 border-purple-200 dark:border-purple-800">
                                                        ...
                                                        <p className="text-sm text-purple-800 dark:text-purple-200">
                                                            Our AI extracts structured data using OCR and Gemini
                                                        </p>
                                                    </Card>
                                                    ...
                                                    <Card className="p-4 bg-green-50 dark:bg-green-900/20 border-green-200 dark:border-green-800">
                                                        <h3 className="font-semibold text-green-900 dark:text-green-300 mb-2 flex items-center gap-2">
                                                            ...
                                                            Step 3: FHIR Integration
                                                        </h3>
                                                        <p className="text-sm text-green-800 dark:text-green-200">
                                                            Data is converted to FHIR format and stored securely
                                                        </p>
                                                    </Card>
                                                </motion.div>
                                            </div>
